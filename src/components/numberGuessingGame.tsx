  ...
  return (
   <div>
     ...
     <h1 className="text-4xl font-bold text-center mt-0" style={{ color: "#ffd60a", textShadow: "2px 2px #003566", backgroundColor: "#000814" }}>
        Day 04 challenge Number Guessing Game 
      </h1>
     {/* Author heading */}
   ...
   <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-[#000814] to-[#001d3d]">
      {/* Main container for the game */}
      <div className="bg-[#003566] text-[#e0e1dd] rounded-lg shadow-lg p-8 w-full max-w-md">
        {/* Title of the game */}
        ...
        {!gameStarted && (
          <div className="flex justify-center mb-4">
            ...
            <Button
              ...
              className="bg-[#ffc300] hover:bg-[#ffd60a] text-[#000814] font-bold py-2 px-4 rounded"
            >
              Start Game
            </Button>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center mb-4">
              ...
              <Input
                ...
                className="bg-[#001d3d] text-[#e0e1dd] border border-[#ffd60a] rounded-lg py-2 px-4 w-full max-w-xs"
                placeholder="Enter your guess"
              />
              {/* Button to submit the guess */}
              <Button
                onClick={handleGuess}
                className="bg-[#ffd60a] hover:bg-[#ffc300] text-[#000814] font-bold py-2 px-4 rounded ml-4"
              >
                Guess
              </Button>
            </div>
