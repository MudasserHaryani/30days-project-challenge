  ...
  return (
    <div>
     ...
     <h1 className="text-4xl font-bold text-center mt-0" style={{ color: "#ffd60a", textShadow: "2px 2px #003566", backgroundColor: "#000814" }}>
        Day 03 challenge Birthday Wishing 
      </h1>
     {/* Author heading */}
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#000814] to-[#001d3d] flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-white bg-[#003566]">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-white">Happy 36th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-300">Mudasser Haryani</CardDescription>
            <p className="text-lg text-gray-200">November 4th</p>
          </CardHeader>
          {/* Card content with candles and balloons */}
          <CardContent className="space-y-6 text-center">
            {/* Candles section */}
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Light the candles:</h3>
            ...
            {/* Balloons section */}
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Pop the balloons:</h3>
              <div className="flex justify-center space-x-2">
          ...
          <CardFooter className="flex justify-center">
            <Button 
              className="bg-[#ffd60a] text-black hover:bg-gray-300 transition-all duration-300"
              onClick={celebrate}
